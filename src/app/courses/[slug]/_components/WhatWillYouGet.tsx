...
export default function WhatWillYouGetSection({
  ...
  return (
    <section className={cn(className)}>
      ...
      <div className="grid w-full grid-cols-2 rounded-2xl border-2 border-yellow-600 bg-gradient-to-br from-yellow-50/60 via-amber-50/40 to-orange-50/30 p-8 py-16">
