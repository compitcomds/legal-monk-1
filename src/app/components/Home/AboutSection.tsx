...
const AboutSection: React.FC = () => {
    return (
        <div className="bg-[#f9f6f3] shadow  w-full bg-no-repeat bg-cover rounded-2xl" style={{ backgroundImage: "url('./icons/stroke2.png')" }}>
            <div className="lg:py-16 py-5 mb-10 px-6 md:px-20 lg:px-40 flex flex-col items-center lg:items-start">
                {/* Left Section */}
