        ...
        <div className="flex flex-col items-center bg-[#f9f6f3] lg:py-10 px-5 md:px-20 lg:px-24 font-title  rounded-b-xl lg:rounded-b-3xl">
            <div className="flex flex-col lg:flex-row items-center justify-between">
                ...
                <div className="flex flex-col text-center md:text-start w-full lg:w-1/2">
                    <h1 className={`${recoleta.className} mt-6 text-4xl md:text-7xl font-bold text-black `}>
                        NAMASTE!
                    </h1>
                    <p className={`${poppins.className} mt-2 lg:mt-8 font-sans text-lg md:text-2xl 2xl:text-4xl leading-5  text-black`}>
            ...
            <div className="mt-10 bg-white shadow rounded-3xl flex flex-col lg:flex-row p-8 lg:p-14 w-full max-w-7xl">
