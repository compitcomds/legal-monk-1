...
const FooterSection: React.FC = () => {
    return (
        <footer className="bg-[#f9f6f3] py-10 px-6 md:px-20 2xl:px-40">
                ...
                <div className="flex  gap-6 w-full">
                    <div className="space-y-8 w-full">
                        <div className="flex items-center justify-center md:justify-start">
                            ...
                            /> */}
                            <h1 className="text-2xl lg:text-3xl 2xl:text-4xl font-bold text-black">Legal Startup Wala</h1>
                        </div>
                        ...
                        <div className="mb-8 md:mb-0">
                            <a href="https://www.instagram.com/legalstartupwala?igsh=Zmo3bDlhZzFzcDVk&utm_source=qr"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 93 92" fill="none">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                        <a href="/notes" className="hover:font-bold 2xl:text-xl text-black hover:text-blue-600 ">Free Resources</a>
                        <a href="/#community" className="hover:font-bold 2xl:text-xl text-black hover:text-blue-600 ">Comunity Courses</a>
                        <a href="/support" className="hover:font-bold 2xl:text-xl text-black hover:text-blue-600 ">My Support System</a></div>
            ...
            <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-4 items-center border-t font-semibold border-gray-200 mt-8 pt-6">
            ...
            <div className="uppercase w-full text-3xl md:text-5xl lg:text-8xl 2xl:text-9xl text-center my-10 lg:my-20 font-semibold">Legal Startup Wala</div>
        </footer>
    );
};
